    ...
    render() {
        ...
        return (
            <div>
                ...
                <div id="viewUsers" style={this.props.actionName === 'viewUsers' ? {'display' : 'block'} : {'display' : 'none'}}>
                ...
                <div id="lastWeekOrders"  style={this.props.actionName === 'lastWeekOrders' ? {'display' : 'block'} : {'display' : 'none'}}>
