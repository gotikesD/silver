            ...
            <div>
                ...
                <div>
                    ...
                    <div style={{'width' : '50%', 'display' :'inlineBlock'}}>
                        <input style={{'width' : '50px' }} placeholder='Go to page' ref="page" onChange={this.changeItemsPerPage.bind(this)} type="text" />
                        <span>Items per page</span>
                        <select style={{'width' : '50px', 'display' : 'block'}} ref='perPage' onChange={this.changeItemsPerPage.bind(this)}>
